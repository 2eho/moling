  ...
  return (
    <div className="relative">
      <button
        ...
        style={{ background: "var(--th-hover)", color: autoFollow ? "var(--th-accent-text)" : "var(--th-text-2)" }}
      >
        ...
        <>
          ...
          >
            ...
            <button
              ...
              style={{ background: autoFollow ? "var(--th-hover-strong)" : "transparent", color: autoFollow ? "var(--th-accent-text)" : "var(--th-text-2)" }}
            >
              <div
                className="w-8 h-8 rounded-lg shrink-0 flex items-center justify-center text-sm"
                style={{
                  background: "linear-gradient(135deg, var(--th-accent-dim), var(--th-hover-strong))",
              ...
              <div className="flex-1 min-w-0">
                <div className="font-medium truncate text-xs" style={{ color: autoFollow ? "var(--th-accent-text)" : "var(--th-text)" }}>
                  跟随系统
                </div>
                <div className="text-[10px] truncate" style={{ color: "var(--th-text-3)" }}>自动匹配亮色/暗色</div>
              </div>
