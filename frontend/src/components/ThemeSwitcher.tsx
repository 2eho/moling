...
const DARK_IDS = ['moling', 'nord', 'onedark', 'dracula', 'solarized-dark']
const LIGHT_IDS = ['solarized-light', 'paper', 'github-light']
...
export function ThemeSwitcher() {
  ...
  const lightThemes = THEMES.filter((t) => LIGHT_IDS.includes(t.id))
  ...
  return (
    <div className="relative">
      <button
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.background = 'var(--th-hover-strong)'
