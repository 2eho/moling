...
export class GlobalErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    console.error("[GlobalErrorBoundary] Caught error:", error.message, errorInfo.componentStack);
  }
        ...
        >
          <div className="text-center max-w-sm px-6">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-xs font-medium transition-all hover:opacity-90 active:scale-95"
              style={{
