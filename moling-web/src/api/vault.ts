...
export async function getCharacters(projectId: string): Promise<Character[]> {
  return api.get<Character[]>(`/projects/${projectId}/vault/characters`);
}
...
export async function createCharacter(
  ...
  return api.post<Character>(`/projects/${projectId}/vault/characters`, request);
}
...
export async function getTimelineEvents(projectId: string): Promise<TimelineEvent[]> {
  return api.get<TimelineEvent[]>(`/projects/${projectId}/vault/timeline`);
}
...
export async function createTimelineEvent(
  ...
  return api.post<TimelineEvent>(`/projects/${projectId}/vault/timeline`, event);
}
...
export async function getCommitments(projectId: string): Promise<Commitment[]> {
  return api.get<Commitment[]>(`/projects/${projectId}/vault/commitments`);
}
...
export async function createCommitment(
  ...
  return api.post<Commitment>(`/projects/${projectId}/vault/commitments`, commitment);
}
...
export async function getWorldviewEntries(projectId: string): Promise<WorldviewEntry[]> {
  return api.get<WorldviewEntry[]>(`/projects/${projectId}/vault/worldview`);
}
...
export async function createWorldviewEntry(
  ...
  return api.post<WorldviewEntry>(`/projects/${projectId}/vault/worldview`, entry);
}
