...
| 文档 | 说明 |
|------|------|
| `DESIGN.md` | 设计系统 v3.1（暗色主题、色阶、排版、组件样式） |
| `docs/ARCHITECTURE.md` | 系统架构（部署拓扑、数据流、技术栈、安全架构） |
| `docs/DEPLOYMENT.md` | 部署指南（Docker/Nginx/云服务器/故障排查） |
| `docs/SPECIFICATIONS.md` | P0/P1/卡牌算法规格（质量门禁、测试要求） |
| `docs/RUNBOOK.md` | 运维手册（7 种故障的 SOP 处理流程） |
| `docs/ONBOARDING.md` | 新开发者上手指南（环境搭建、代码规范） |
| `fe-specs.md` | 前端 Phase 4 & 健康监控生产级规格 |

> 设计阶段历史文档（算法设计、后端设计、接口映射、测试方案等）已归档至 `docs/archive/`。
